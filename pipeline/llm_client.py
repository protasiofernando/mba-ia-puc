...
Configuravel via variaveis de ambiente:
  ...
  OLLAMA_MODEL - modelo a usar         (padrao: gemma4:26b-q8)
...
Duas praticas adotadas no uso do Ollama (validas para qualquer modelo):
  ...
  2. think=False no payload. Modelos de raciocinio (como o gemma4:26b-q8) colocam
     ...
     sem raciocinio o parametro e simplesmente ignorado. Ver docs/NOTAS_TECNICAS.md.
"""
...
DEFAULT_MODEL = os.getenv("OLLAMA_MODEL", "gemma4:26b-q8")
